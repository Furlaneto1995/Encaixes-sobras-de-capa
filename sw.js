var CACHE_NAME = 'encaixes-v25'; // Subir este número a cada publicação força a atualização
...
self.addEventListener('fetch', function(event) {
    ...
    if (
        // O motor do cálculo nunca pode ser guardado em cache: cada pedido
        // envia planilhas diferentes e precisa chegar ao servidor.
        url.indexOf('onrender.com') > -1 ||
        url.indexOf('/calcular') > -1 ||
        url.indexOf('/diagnosticar') > -1 ||
        url.indexOf('/acordar') > -1 ||
        url.indexOf('recaptcha') > -1 ||
        url.indexOf('firebaseappcheck.googleapis.com') > -1 ||
